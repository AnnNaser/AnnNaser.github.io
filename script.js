...
${data.message}
        ...
        const mailtoLink = `mailto:ann.n.nabil@gmail.com?subject=${emailSubject}&body=${emailBody}`;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const criticalImages = [
    './assets/professional image_Ann Naser Nabil.png',
    './assets/cursor.png'
  ];
